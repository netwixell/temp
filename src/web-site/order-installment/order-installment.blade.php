<section class="buying buying--installment">
  <div class="container buying__container">
    <h1 class="buying__title visually-hidden">@lang('orders.title_installment')</h1>
    ...
    <div class="tabs tabs--content" data-tabs-content>
      <div class="buying__inner tabs-pane active" id="ordering" data-tabs-pane>
        <div class="buying__wrapper">
          ...
          <div class="info buying__info"><b class="info__title">@lang('orders.about-installment')</b>
           <p class="info__text">@lang('orders.info-installment-1',['payment'=>thin_uah($installment_plan['monthly_payment']), 'expires'=>locale_date($installment->expires_at)])</p>
            <p class="info__text">@lang('orders.info-installment-2',['payment'=>thin_uah($installment_plan['first_payment'])])</p>
          </div>
        </div>
        <div class="buying__wrapper">
          ...
          <div class="payment-details buying__payment-details"><b class="payment-details__title">@lang('orders.payment-details_title-1')</b>
            ...
            <b class="payment-details__title payment-details__title--text">@lang('orders.payment-details_text-2')</b>
            <?php $phones = getPaymentPhones();  ?>
        ...
        <div class="buying__wrapper">
          <table class="ticket buying__ticket">
            ...
            <tfoot>
              <tr class="ticket__total">
                <th class="ticket__offer ticket__offer--total">@lang('orders.ticket_total')</th>
                <td class="ticket__price ticket__price--final">@lang('orders.installment-price',['price'=>thin_uah($installment_plan['monthly_payment'])])</td>
              </tr>
            </tfoot>
          </table>
          <div class="payment-details buying__payment-details"><b class="payment-details__title">@lang('orders.payment-details_title-1')</b>
