...
import Validation from './../../common/js/ValidationOld';
...
(function (form) {
  ...
  if (inp_phone) {
    window.mask = new IMask(inp_phone, phoneMask);
  }
      ...
      if (errors) {
        ...
        for (var field in errors) {
          if (errors.hasOwnProperty(field)) {
            ...
            if(field == 'slug') alertMessage(errors[field].pop());
            else validation.flash(field, errors[field].pop());
          }
        }
