                          ...
                          <div class="row">
                            <div class="col-md-8">
                              <div class="form-group">
                                  ...
                                  <ul class="radio">
                                    @if(isset($dataTypeContent::$payment_types))
                                            ...
                                            @php
                                              ...
                                              if(!isset($installment) && $selected_value == $payment_installments){
                                                $installment = $dataTypeContent->installment;

                                                if($installment->closed_at->diffInDays(now()) > 5) $installment = null;
                                              }
                                            @endphp
                                ...
                                <p>Тип оплаты выбранный покупателем &ndash; {{__('orders.'.$selected_value)}}</p>
