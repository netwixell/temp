            ...
            <div class="row">
                <div class="col-md-8">
                  ...
                  <!-- ### SEO CONTENT ### -->
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="slug" name="slug" placeholder="slug"
                                    ...
                                    value="@if(isset($dataTypeContent->slug)){{ $dataTypeContent->slug }}@endif" required>
                            </div>
                            <div class="form-group">
                    ...
                    @if(isset($dataTypeContent->id) && View::exists('voyager::pages.partials.'.$dataTypeContent->slug))
                        @include('voyager::pages.partials.'.$dataTypeContent->slug)
                    @endif
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-image"></i> og:image</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            @php
                                ...
                                $exclude = ['title', 'body', 'excerpt', 'slug', 'status', 'created_at', 'image', 'meta_description', 'meta_keywords', 'seo_title'];
                            @endphp
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status">
                                    <option value="ACTIVE"@if(isset($dataTypeContent->status) && $dataTypeContent->status == 'ACTIVE') selected="selected"@endif>Активна</option>
                                    <option value="INACTIVE"@if(isset($dataTypeContent->status) && $dataTypeContent->status == 'INACTIVE') selected="selected"@endif>Отключена</option>
                                </select>
                            </div>
                        </div>
                    </div>
